                ...
                <div class="col-sm-10 custom-margin">
                    ...
                    <div class="row custom-data-border">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group p-3">
                                <label for="doanh_so_thang"
                                    >Doanh số tháng</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                                    id="doanh_so_thang"
                                    v-model="doanh_so_thang"
                                    :disabled="true"
                                />
                            </div>
                        </div>
...
export default {
    ...
    async created() {
        ...
        this.doanh_so_thang = "Doanh số tháng 0" + (new Date().getMonth() + 1);
    },
    methods: {
        async createDataKho() {
            this.$v.$touch();
